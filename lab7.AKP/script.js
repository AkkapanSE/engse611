document.addEventListener('DOMContentLoaded', function() {
    ...
    if (profileImage && profileTooltip) {
        ...
        profileImage.addEventListener('click', function() {
            createAndShowModal('<img src="https://i.pinimg.com/736x/3d/fc/90/3dfc9051222c4be19af3b4513ab250d4.jpg" alt="Profile Large" style="max-width:100%;">');
        });
    }
